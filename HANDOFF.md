...
6. Optional future autostart integration if the sidecar should launch alongside the controller every time.
7. Optional direct Telegram polling fallback only if local session logs prove unreliable.
